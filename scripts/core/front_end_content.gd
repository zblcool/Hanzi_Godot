		...
		"route_preview": {
			...
			"next_row_handoff": {
				...
				"action_hint": {
					...
					"en": "Tap any handoff card to retarget the main focus, Route Ribbon, and linked preview together."
				},
				"open_count_format": {
					"zh": "%s · 已开 %d 个节点",
					"en": "%s · %d rooms open"
				...
				"card_hint_badge": {"zh": "点按切到这一格", "en": "Tap To Focus"},
				"footnote_format": {
					"zh": "当前聚焦：%s。source 真正开跑时，下一排只会点亮这些直连房间，并同时把它们的后手压力一起暴露出来；现在也能直接点按这些卡，顺着塔图继续把样张焦点往前推。",
					"en": "Current focus: %s. In the live source climb, only these directly connected rooms would light up on the next row along with the downstream pressure each one creates, and Godot now lets those cards push the sample focus forward directly."
				},
...
const MENU_PAGE_CONTENT := {
	...
	"reaction_prompt": "点一下角色，让他先开口。",
	"detail_preview_hint": "轻触当前展示位，重播执笔回应。",
...
const MENU_ARCHIVE_CONTENT := {
	...
	"build_route_radical_title": "源稿偏旁偏向",
...
const MENU_LEADERBOARD_CONTENT := {
	...
	"featured_title_manual": "当前最佳定卷",
	"featured_title_test": "当前最佳试阵",
	"history_title": "其余战绩",
	"history_summary_format": "继续回看剩余 %d 条 build 结果。",
	"show_more_history_format": "展开其余 %d 条",
	"show_less_history": "收起其余战绩",
	"featured_badge": "当前最佳",
	"rank_tag_format": "#%d",
	"section_radicals": "偏旁",
	"section_glyphs": "成字",
	"section_phrases": "词技",
	"section_takedowns": "击倒",
	"main_board": "主卷榜",
	"test_board": "试阵榜",
...
const MENU_EN_TEXT := {
	...
	"点一下角色，让他先开口。": "Tap the hero and let them answer first.",
	...
	"当前最佳定卷": "Current Best Main Run",
	"当前最佳试阵": "Current Best Test Run",
	"其余战绩": "Remaining Runs",
	"继续回看剩余 %d 条 build 结果。": "Review the remaining %d build results.",
	"展开其余 %d 条": "Show %d more",
	"收起其余战绩": "Collapse remaining runs",
	"当前最佳": "Current best",
	"偏旁": "Radicals",
	"成字": "Glyphs",
	"词技": "Phrases",
