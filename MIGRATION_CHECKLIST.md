...
- `[in progress]` Move launcher / menu content into data-driven definitions. Notes: `scripts/core/front_end_content.gd` now drives launcher cards, launcher update/changelog data, Cangjie portal sections, menu top actions, and menu quick-start entries; larger overlays and per-panel body copy still remain inline in scene scripts.
