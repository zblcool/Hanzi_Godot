...
- `[in progress]` More stage spectacle for big unlocks and transitions. Notes: Godot battle HUD now adds larger centered reveal cards for new glyphs, phrase arts, `字境相变`, boss arrivals, chapter-secured beats, and a source-style `续卷入深层 / Continue Deeper` chamber advance state, but later-room dungeon transitions and other flourishes can still be pushed further.
