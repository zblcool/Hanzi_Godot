...
- `[in progress]` Higher-end hit/audio differentiation follow-through. Notes: the synth pass now covers attacks, impacts, pickups, marquee battle beats, ground-telegraph / charge-warning cues, split frontline / skirmisher / brute / elite / boss hit-break textures, and a distinct player-collapse cue; broader word-skill layering and richer hero-specific hurt stingers still remain.
