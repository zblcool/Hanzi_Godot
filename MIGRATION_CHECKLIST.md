...
- `[in progress]` Phrase / idiom guardian encounters. Notes: `简库中庭 / Slip Archive` now has `风雨同舟`, `海上生明月`, and `山高水长`, including mixed guardian families via ranged and tank sentence watchers, but the wider phrase pool and later-room guardian routing still need follow-through.
...
- `[in progress]` More map-event reward routing. Notes: Godot now carries heal, `字墨`, and map-reveal guarded-phrase rewards in `简库中庭 / Slip Archive`, but the broader radical sentence outcomes still remain unported.
