...
- `[in progress]` Higher-end hit/audio differentiation follow-through. Notes: the first synth pass now covers attacks, impacts, pickups, marquee battle beats, plus enemy ground-telegraph / charge-warning cues and their activation blooms, but broader hurt / death variation and deeper layering across future word-skill branches are still missing.
