...
- `[in progress]` More front-end hero flavor beyond the archive pass. Notes: Godot now mirrors the source card-side quote bubble, selected marker, and source-style scholar/xia avatar silhouettes across the menu spotlight, hero cards, and archive panels alongside the existing selection quotes and battle-side callouts, but there are still extra front-portal framing beats that have not been ported.
