...
- `简库中庭 / Slip Archive` 里现在也补上了第一道 `风雨同舟` 句阵守卫：靠近句碑会唤出守句魁首，击败后可获得一段回气奖励，先把 source 里的 guarded phrase event 接回第一刀
...
- 成语 / 句子类地图事件已经接回第一道 `句阵守卫`，但更广的句池、更多奖励分支和后续房间布置仍在迁移清单里继续追赶
